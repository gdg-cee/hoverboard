The core idea of the event is to get introduced to all neighbour organizers and make new friends, so _each attending GDG chapter must prepare a small presentation_ to introduce themselves.
